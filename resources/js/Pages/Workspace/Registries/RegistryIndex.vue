        ...
        <div class="bg-white rounded-md shadow overflow-x-auto">
            <table class="w-full whitespace-nowrap">
                ...
                <tr v-for="registry of registries.data" :key="registry.id"
                    ...
                    <td class="border-t">
                        <Link value="Edit" :href="route('workspace.registries.show', [registry.company_id, registry.registry_id])"
                    ...
                    <td class="w-px border-t">
                        <Link class="flex items-center px-4" :href="route('workspace.registries.show', [registry.company_id, registry.registry_id])" tabindex="-1">
