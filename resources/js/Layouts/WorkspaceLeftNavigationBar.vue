    ...
    <div class="flex-shrink-0 hidden md:block w-56 p-12 bg-cyan-700">
        ...
        <div v-if="$page.props.auth.user.id === 1">
            ...
            <Link :href="route('admin.dashboard')" class="flex items-center group">
                ...
                <div class="text-zinc-300 group-hover:text-white">Admin</div>
            </Link>
        </div>

        <div v-else-if="companiesCount > 1">
            <hr class="p-4">
            <Link :href="route('workspace.selector')" class="flex items-center group">
