<template>
    <div class="block whitespace-nowrap">
        <div v-if="$page.props.flash.success && show" class="sm:mt-0 mt-2 flex items-center justify-between p-2 bg-green-500 rounded">
            <div class="flex items-center">
                ...
                <div class="text-white text-sm font-medium">{{ $page.props.flash.success }}</div>
            </div>
            <button type="button" class=" ml-6 group mr-2" @click="show = false">
        ...
        <div v-if="($page.props.flash.error || Object.keys($page.props.errors).length > 0) && show" class="sm:mt-0 mt-2 flex items-center justify-between p-2 bg-red-500 rounded">
            <div class="flex items-center">
                ...
                <div v-if="$page.props.flash.error" class="text-white text-sm font-medium">{{ $page.props.flash.error }}</div>
