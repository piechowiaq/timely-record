<template>
    <div>
        <div v-if="$page.props.flash.success && show" class="flex items-center justify-between p-2 bg-green-500 rounded">
        ...
        <div v-if="($page.props.flash.error || Object.keys($page.props.errors).length > 0) && show" class="flex items-center justify-between p-2 bg-red-500 rounded">
            <div class="flex items-center">
